      ...
      <div className="container mx-auto">
        ...
        <div className="mx-auto ">
          <div className="flex flex-col content-center gap-5 mt-8 lg:flex-row">
            <div className="relative basis-3/3 lg:basis-1/3 md:basis-2/3">
              <div className="h-full bg-white rounded-3xl px-7 pt-7 lg:pt-9 pb-28">
                ...
                <ul>
                  ...
                  <li className="flex items-start mb-2">
                    <img src={PriceGreenTick} className="w-4 mr-2" />
                    <span className="text-sm md:text-sm text-selfGray">
                ...
                >
                  <Link
                    ...
                    className="leading-5 text-sm font-medium"
                  >
                    Start Saving
                  </Link>
                </div>
            ...
            <div className="relative basis-3/3 lg:basis-1/3 md:basis-2/3">
              <div
                className="h-full bg-darkGreen rounded-3xl px-7 pt-7 lg:pt-9 pb-28"
              ...
              >
                ...
                <div
                  className="absolute bottom-5 lg:bottom-7 left-7 right-7 bg-coffee  border-2 mt-auto hover:shadow-custom  border-darkGreen rounded-[30px] cursor-pointer
