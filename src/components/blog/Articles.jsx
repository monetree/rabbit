        ...
        <div className='p-4 lg:px-16 py-6'>
            ...
            <div className='bg-white rounded-xl md:flex md:items-center'>
                <div className='relative md:w-1/2'>
                    <img src={blog1} className='rounded-xl max-h-[322px] w-full object-cover relative' alt="" />
                ...
                <div className='p-3 space-y-2 md:p-6 md:w-1/2'>
                    <div className='flex items-center text-xs lg:text-sm text-darkGreen font-semibold'>
                    ...
                    <div className='font-bold lg:text-xl'>
                        Our members save an average of $325 annually
                        from our partner brands
                    </div>
                    <div className='text-xs'>
                        Our members save an average of $325 annually from our partner brands. Our members save an average of $325 annually from our partner brands. Our members save an average of $325 annually from our partner brands.
                    </div>
                    <div className='flex items-center text-xs text-darkGreen font-semibold lg:text-sm'>
                        <div className='pt-1'>
                            Read more
                        </div>
            ...
            <div className='my-3 space-y-4 md:flex md:space-x-3 md:space-y-0'>
                ...
                <div className='md:w-3/12'>
                    <Card author={'Stephanie Faris'} name={'Top Sale Products In 2023'} time={'December 20, 2023'} img={blog4} />
                </div>
                <div className='md:w-3/12'>
                    <Card author={'Stephanie Faris'} name={'Top Sale Products In 2023'} time={'December 20, 2023'} img={blog5} />
                </div>
            </div>
