    ...
    return (
        <div className='bg-white rounded-xl flex max-h-[140px]'>
            <div className='w-1/2 max-w-[170px] relative'>
                <img src={img} className='rounded-xl w-full h-full object-cover absolute' alt="" />
            ...
            <div className='p-4 space-y-2 w-1/2 flex flex-col justify-between'>
                <div>
                    <div className='flex items-center text-xs text-darkGreen font-semibold '>
                        <img src={human} className='h-3' alt="" />
                        <div className='pl-2 pt-1'>
                            {author}
                        </div>
                    </div>
                    <div className='font-bold pt-3 text-sm'>
                        {name}
                    </div>
                </div>
                <div className='flex items-center text-xs text-darkGreen font-semibold'>
