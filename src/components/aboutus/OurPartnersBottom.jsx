...
const OurPartnersBottom = () => {
  return (
    <div className="px-4 lg:px-20 py-10">
      <div className="text-sm text-coffee uppercase">Our partners</div>
      <div className="flex justify-between max-sm:block">
        <div className="text-3xl w-3/6 my-6 font-semibold text-dark max-sm:w-full">
          Our members save an average <br /> of{" "}
          <span className="text-coffee">$325 annually</span> from our <br />{" "}
          partner brands
        </div>
        <div className="text-sm w-3/6 my-7 ml-4 text-selfGray max-sm:w-full max-sm:ml-0">
