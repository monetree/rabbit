                ...
                <div className='relative w-full mt-5'>
                    <div className=''>
                        <Slider
                            ...
                            className=''
                        >
                            <ReviewMsg text={'The $79 annual subscription was an absolute no-brainer for me! I spend  $300+ per month on my health practice. Many of those expenses qualify  for HSA dollars through Crates, saving me $100+ monthly.'} />
                            <ReviewMsg text={'The $79 annual subscription was an absolute no-brainer for me! I spend  $300+ per month on my health practice. Many of those expenses qualify  for HSA dollars through Crates, saving me $100+ monthly.'} />
                            <ReviewMsg text={'The $79 annual subscription was an absolute no-brainer for me! I spend  $300+ per month on my health practice. Many of those expenses qualify  for HSA dollars through Crates, saving me $100+ monthly.'} />
                        </Slider>
                        ...
                        >
                            <CustomerProfile img={Group2} name={'Viren B'} profession={'Personal IT Expert'}/>
                            <CustomerProfile img={Img34} name={'Viren B'} profession={'Personal IT Expert'}/>
                            <CustomerProfile img={Img4} name={'Viren B'} profession={'Personal IT Expert'}/>
                        </Slider>
                    </div>
                </div>
            </div>
